...
| Heavy menstrual bleeding | PBAC (Pictorial Blood Loss Assessment Chart) | product/saturation/clot/flooding points; cutoffs 100 (76 secondary) | Higham et al. (1990), *BJOG* 97(8):734–739 | published scoring (no code dependency) | unit-tested (`PbacScorerTest`, 12/12) | Scoring engine implemented; module/UI pending; gated |
| Perimenopause | Greene Climacteric Scale (permission-free; Peri-SS a digital-native alternative) | 21 items, 0–3, six domains (Anxiety, Depression, Somatic, Vasomotor, Sexual; + combined Psychological) | Greene (1998), *Maturitas* 29(1):25–31 | published scoring (no code dependency) | unit-tested (`GreeneScaleTest`, 5/5) | Scoring engine implemented; module/UI pending; gated |
